...
<?php
require "connect_bank.php";

$error="*Check for availability of blood";

session_start();

if (!empty($_POST["Blood_Group"]) && !empty($_POST["xx-ml"])) 
{
	$error="";
	$bldg=$_POST["Blood_Group"];
	$amnt=$_POST["xx-ml"];

	$query="select Current_Volume from blood_record where Blood_Group='$bldg'";

	$query_run=mysqli_query($mycon,$query);
	if ($query_run) 
	{
		$data=mysqli_fetch_assoc($query_run);
		if ($data["Current_Volume"]>$amnt) 
		{
			header("location:recenabled.html");
			
		}
		else {

				$error="* Sorry we are unable to provide blood of $bldg bloodgroup";
...
<div class="container">
	<div class="welcome" >
  <h1>Welcome Reciever!</h1>
</div>
  <div class="row">
    <div class="col-sm-6" >
	<p style="color:red;"><?php echo $error ?></p>
    <a href="#"><button style="height:100px; width: 500PX;" type="button" class="btn btn-info btn-lg" disabled>Proceed</button></a><br>    
	<div style="margin-top:35px;" >
	<button style="height:100px; width: 500PX;" type="button" class="btn btn-info btn-lg" data-toggle="modal" data-target="#myModal">Check Availability</button>
	<br><br>
	</div>
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content" style="margin-top:200px;">
        <div class="modal-header">
         ...
         <form action="recdisabled.php" method="POST"> 
